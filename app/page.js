...
export default function Home() {
  ...
  const jsonLd = {
    ...
    description:
      'Профессиональная разработка сайтов, интернет-магазинов и веб-сервисов в Москве. Стеке технологий: Next.js, React, WebGL. Премиум качество по рыночной цене.',
    ...
    <>
      ...
      <div className={`transition-opacity duration-700 ease-in-out ${isReady ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <main className="relative w-full h-screen bg-black overflow-hidden flex flex-col justify-center items-center">
          ...
          {/* НИЖНЯЯ ПАНЕЛЬ: Техничское SEO и Гео */}
          <div
            ref={bottomBarRef}
